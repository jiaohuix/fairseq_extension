...
if __name__ == '__main__':
    tokenizer = AutoTokenizer.from_pretrained("facebook/nllb-200-distilled-600M", use_auth_token=access_token,src_lang='zho_Hans')
    print(tokenizer)
    # print(tokenizer.vocab_file)
    print(tokenizer.vocab_size,"vsize??") # 256204
    print(tokenizer.lang_code_to_id["zho_Hans"])
    print(tokenizer.lang_code_to_id["arb_Arab"])
  #   res = []
  #   for idx in range(0,256206):
  #       a = tokenizer._convert_id_to_token(idx)
  #       if a is not None:
  #           a = a+"\n"
  #           res.append(a)
  #       else:
  #           print(a,idx)
  # # print(res)
  #   with open("nllb_dict.txt","w",encoding="utf-8") as f:
  #       f.writelines(res)
  #   '''
  #   256204 vsize??
  #   None 256204
