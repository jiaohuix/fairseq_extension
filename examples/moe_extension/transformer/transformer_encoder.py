...
from .modules.dist import fsdp_wrap
from fairseq.models import FairseqEncoder
from .transformer_config import TransformerConfig
from .fsdp_wrap_expert import fsdp_wrap_expert
...
from .modules.transformer_layer import    TransformerEncoderLayer
...
class TransformerEncoderBase(FairseqEncoder):
    ...
    def forward(
        ...
        return self.forward_scriptable(
            src_tokens, src_lengths, return_all_hiddens, token_embeddings, entity_ids = entity_ids, entity_len = entity_len
        )
    ...
    def forward_scriptable(
        ...
        '''
        moe_gate_loss:
        [None, tensor(1.0625, device='cuda:0', dtype=torch.float16, grad_fn=<AddBackward0>), 
        None, tensor(1.1104, device='cuda:0', dtype=torch.float16, grad_fn=<AddBackward0>), 
        None, tensor(1.2812, device='cuda:0', dtype=torch.float16, grad_fn=<AddBackward0>)]
        '''
