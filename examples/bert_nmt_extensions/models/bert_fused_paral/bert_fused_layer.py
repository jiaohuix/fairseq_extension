...
from bert_nmt_extensions.modules import DynamicGate,DynamicGateGLU,DynamicGateGLUNorm,ZeroGate,build_dynamic_gate
    ...
    def forward(
        ...
        if self.bert_gate:
            ...
            # if self.cfg.fuse_lr_multiply > 1:
                ...
                # x = GradMultiply.apply(x, 1.0 / self.cfg.fuse_lr_multiply)
...
class BertFusedDecoderLayer(TransformerDecoderLayerBase):
    def __init__(
        ...
        ### layer select for bert ###
        self.select_layer = create_select_layer(ls_type=cfg.ls_type, bert_output_layer=cfg.bert_output_layer,
                                                is_decoder=True) if self.bert_gate else None
