...
if __name__ == '__main__':
    file1 = "../data-bin/zhar/dict.zh.txt"
    file2 = "../datasets/dict.zh.txt"
    # file2 = "../datasets/ikcest.zh.txt"
    ...
    print(unk_ls,len(unk_ls)) #  3256

    new_dic = {}
    import jieba
    # for unk in unk_ls:
    #     # words = jieba.lcut(unk)
    #     words = [word for word in unk]
    #     for word in words:
    #         new_dic[word]=1
    #         print(word,check_is_encode_error(word))
    # print(new_dic,len(new_dic)) # 2597
