...
#subexp="tok_moe_k2_dot_avg"
#exp_args="--ls-type tok_moe_k2_dot_avg"
#experiment_pipe $subexp $data $save_base $log_dir $exp_args
#
#subexp="tok_moe_k2_dot_max"
#exp_args="--ls-type tok_moe_k2_dot_max"
#experiment_pipe $subexp $data $save_base $log_dir $exp_args



#subexp="tok_moe_k2_dot_avg_rm"
#exp_args="--ls-type tok_moe_k2_dot_avg_rm"
#experiment_pipe $subexp $data $save_base $log_dir $exp_args

subexp="tok_moe_k2_dot_max_rm"
exp_args="--ls-type tok_moe_k2_dot_max_rm"
experiment_pipe $subexp $data $save_base $log_dir $exp_args



#subexp="tok_moe_k2_dot_avg_rand"
#exp_args="--ls-type tok_moe_k2_dot_avg_rand"
#experiment_pipe $subexp $data $save_base $log_dir $exp_args

subexp="tok_moe_k2_dot_max_rand"
exp_args="--ls-type tok_moe_k2_dot_max_rand"
experiment_pipe $subexp $data $save_base $log_dir $exp_args
