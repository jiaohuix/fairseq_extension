...
from transformers import PreTrainedTokenizer, AutoTokenizer, BertTokenizer,BertTokenizerFast,XLMRobertaTokenizerFast
...
def _make_binary_dataset(
    ...
    ####################################### BERT-FUSED ##############################################
    output_prefix += '.bert' if isinstance(vocab, (PreTrainedTokenizer,AutoTokenizer,BertTokenizer,BertTokenizerFast,XLMRobertaTokenizerFast)) else ''
    input_prefix += '.bert' if isinstance(vocab, (PreTrainedTokenizer,AutoTokenizer,BertTokenizer,BertTokenizerFast,XLMRobertaTokenizerFast)) else ''
    ####################################### BERT-FUSED ##############################################
