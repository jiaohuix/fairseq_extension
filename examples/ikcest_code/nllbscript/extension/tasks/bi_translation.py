...
@dataclass
class BiTranslationConfig(TranslationConfig):
...
def load_langpair_dataset(
    ...
    forward_dataset  =  LanguagePairDataset(
        src_dataset,
        src_dataset.sizes,
        src_dict,
        tgt_dataset,
    ...
    backward_dataset  =  LanguagePairDataset(
        tgt_dataset,
        tgt_dataset_sizes,
        tgt_dict,
        src_dataset,
...
@register_task("bi_translation", dataclass=BiTranslationConfig)
class BiTranslationTask(TranslationTask):
    """
    ...
    cfg: BiTranslationConfig

    def __init__(self, cfg: BiTranslationConfig, src_dict, tgt_dict):
