...
exp_name="exp_bnmt_qblock_deltop"
...
# 1.删除top的query
subexp="qb1_del"
exp_args="--del-top-qtok --q-layers 1 --n-query 8  --q-drop 0.1  --arch bnmt_qb_iwslt_de_en --bert-model-name  $ptm "
...
# # drop 0
# subexp="qb1_del_dp0"
# exp_args="--del-top-qtok --q-layers 1 --n-query 8  --q-drop 0.  --arch bnmt_qb_iwslt_de_en --bert-model-name  $ptm "
# experiment_pipe $subexp $data $save_base $log_dir  $exp_args

# subexp="qb1_no_del_dp0"
# exp_args="--q-layers 1 --n-query 8  --q-drop 0.  --arch bnmt_qb_iwslt_de_en --bert-model-name  $ptm "
# experiment_pipe $subexp $data $save_base $log_dir  $exp_args


# # drop0 + layernorm
# subexp="qb1_del_dp0_lnorm"
# exp_args="--del-top-qtok --q-layers 1 --n-query 8 --layernorm-embedding  --q-drop 0.  --arch bnmt_qb_iwslt_de_en --bert-model-name  $ptm "
# experiment_pipe $subexp $data $save_base $log_dir  $exp_args

# subexp="qb1_no_del_dp0_lnorm"
# exp_args="--q-layers 1 --n-query 8  --layernorm-embedding  --q-drop 0.  --arch bnmt_qb_iwslt_de_en --bert-model-name  $ptm "
# experiment_pipe $subexp $data $save_base $log_dir  $exp_args
